...
/**
 * 	Implementation for Export Payment from Venezuela bank for Payroll
 * 	@author Yamel Senih, ysenih@erpya.com, ERPCyA http://www.erpya.com
 *  @contributor Jesús Albujas, jalbujas@erpya.com
 */
public class VenezuelaNomina_V1 extends LVEPaymentExportList {
	...
	public int exportToFile(List<MPaySelectionCheck> checks, File file, StringBuffer error) {
		...
		try {
			...
			MClient client = MClient.get(paySelection.getCtx(), paySelection.getAD_Client_ID());
			...
			//	Add padding
			clientName = rightPadding(clientName, 41, " ", true);
			String constant = "01";
			//	Payment Amount

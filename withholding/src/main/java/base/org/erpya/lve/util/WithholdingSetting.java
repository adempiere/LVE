 ...
 */
public class WithholdingSetting {

	private WithholdingSetting() {
		
	}
	
	/** Engine Singleton				*/
	private static WithholdingSetting settingEngine = null;
	 ...
	 */
	public synchronized static WithholdingSetting get() {
		if (settingEngine == null)
			settingEngine = new WithholdingSetting();
...
//		return runApplicability(ctx, trxName, null, applicabilityList, parameters);
	 ...
	 * @return
	 */
	public String fireProcessAgreement(Properties ctx, 
...
//		}
	 ...
	 * @return
	 */
	private String runApplicability(Properties ctx, String trxName, PO po, 
			//List<MFMFunctionalApplicability> applicabilityList, 
...
//				AbstractWithholdingSetting settingForRun = applicability.getSetting();
//				//	Validate Null Value

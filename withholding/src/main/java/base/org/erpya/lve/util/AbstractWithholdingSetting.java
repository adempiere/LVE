...
//	public AbstractWithholdingSetting(MFMFunctionalSetting setting) {
...
//		String trxName = (String) getParameter(WithholdingSetting.PARAMETER_TRX_NAME);
//		PO entity = (PO) getParameter(WithholdingSetting.PARAMETER_PO);
//		MFMAccount account = (MFMAccount) parameters.get(WithholdingSetting.ACCOUNT_PO);
//		if(account == null) {
//			return null;
//		}
//		//	

 ...
 */
public class BanplusBPTaxID_L10 extends LVEPaymentExportList {

	/** Logger								*/
	static private CLogger	s_log = CLogger.getCLogger (BanplusBPTaxID_L10.class);
	/**	separator	*/
					...
					.forEach(payselectionCheck -> {
						...
						if(bpAccount != null) {
							...
							if(!Util.isEmpty(bPTaxId)){
								...
								bPTaxId = String.format("%1$" + 10 + "s", bPTaxId);
								bPTaxId = bPTaxId.substring(0, 10);
							} else {
